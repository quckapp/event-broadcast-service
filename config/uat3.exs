...
# Run with: MIX_ENV=uat3 mix run --no-halt
# =============================================================================
...
# Kafka - UAT3 (for event distribution)
config :event_broadcast_service, :kafka,
  brokers: [System.get_env("KAFKA_BROKER") || "localhost:9092"],
  consumer_group: "event-broadcast-service-uat3",
  topics: %{
    events: System.get_env("KAFKA_EVENTS_TOPIC") || "quckapp-events-uat3",
    broadcasts: System.get_env("KAFKA_BROADCASTS_TOPIC") || "quckapp-broadcasts-uat3"
  }
